...
static void print_usage(const char *prog) {
    ...
    fprintf(stderr, "  -experts <n>  MoE experts per token (3..8, default: 8; 4 recommended -- faster,\n");
    fprintf(stderr, "                no measured quality loss. Do NOT use 1-2: incoherent output.)\n");
