...
**Context length: 262144 native; ~1M via opt-in YaRN + INT4 KV (CUDA, experimental).**
See [Long context beyond 262144](#long-context-beyond-262144-yarn--int4-kv--experimental) for details.
